...
<head>
    ...
    <title>Periodos - Administrador</title>
        ...
        <section class="lista-periodos">
            <div class="periodos-header">
                <div>
                    ...
                    <p class="periodos-sub"><?php echo count($periodos); ?> periodos encontrados</p>
                </div>
            ...
            <div class="periodos-grid">
                <?php if (empty($periodos)): ?>
                    <div class="empty-state">
                        ...
                        <p>Comienza creando el primer periodo para este ciclo</p>
                        <button class="btn-agregar-empty" id="btnNuevoPeriodoEmpty">
                            <i class="fa-solid fa-plus"></i> Crear periodo
                        </button>
                    </div>
                <?php else: ?>
            ...
            <div class="modal-content">
                ...
                <form id="formPeriodo" method="POST" action="logica/procesar_periodos.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="modalNombre" name="nombre" placeholder="Ej: Primer Trimestre" required>
                    </div>
