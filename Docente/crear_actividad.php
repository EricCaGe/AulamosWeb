...
<body>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <!-- RELLENO: FORMULARIO DE ACTIVIDAD -->
                ...
                <div class="left-column">
                    <form class="activity-form">
                        ...
                        <div class="form-group-clean">
                            ...
                            <textarea class="clean-textarea" rows="3"></textarea>
                        </div>

                        <div class="form-group-clean">
                            <label>Instrucciones para los estudiantes</label>
                            <div class="rich-text-editor">
                                ...
                                <textarea class="clean-textarea no-top-border" rows="4" placeholder="Escribe las instrucciones aqui"></textarea>
                            </div>
                        </div>

                        <div class="form-toggle-row">
                            <label>Permitir la entrega de archivos</label>
                            <label class="switch">
