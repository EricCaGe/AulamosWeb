...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        if ($stmt->affected_rows > 0) {
            ...
            $mensaje =
                'No fue necesario realizar cambios o el recurso no pertenece al docente.';
...
$activos =
    (int) ($conteos['activos'] ?? 0);

$inactivos =
    (int) ($conteos['inactivos'] ?? 0);

$archivados =
    (int) ($conteos['archivados'] ?? 0);
    ...
    <main class="main-content recursos-main">
        ...
        <header class="recursos-header">
            ...
            <div>
                ...
                <p>
                    Administra los recursos que has publicado
                    desde Aulamos Web o la aplicación móvil.
                </p>
        ...
        <section class="filtros-recursos">
            ...
            <?php foreach ($filtros as $filtro): ?>
                ...
                <a
                    ...
                    ?>"
                    class="filtro-recurso <?php
                        echo $filtroEstado === $filtro
                            ? 'activo'
                            : '';
                    ?>"
                >
                    ...
                    <article class="mis-recurso-card">
                        ...
                        <div class="recurso-acciones">
                            ...
                            <?php if (!empty($recurso['url_recurso'])): ?>
                                ...
                                <button
                                    type="button"
                                    class="btn-recurso btn-abrir js-abrir-recurso"
                                    data-url="<?php
                                        echo htmlspecialchars(
                                            $recurso['url_recurso'],
                                            ENT_QUOTES,
                            ...
                            <?php if ($recurso['estado'] === 'Activo'): ?>
                                ...
                                <form method="POST">
                                    ...
                                    <button
                                        type="submit"
                                        class="btn-recurso btn-inactivar"
                                    >
                            ...
                            <?php if ($recurso['estado'] !== 'Archivado'): ?>
                                ...
                                <form
                                    method="POST"
                                    onsubmit="return confirm('¿Archivar este recurso?');"
                                >
                                    ...
                                    <button
                                        type="submit"
                                        class="btn-recurso btn-archivar"
                                    >
        ...
        <?php else: ?>
            ...
            <section class="sin-recursos">
                ...
                <p>
                    No encontramos recursos con el filtro seleccionado.
                </p>
...
(function () {
    ...
    document
        .querySelectorAll('.js-abrir-recurso')
